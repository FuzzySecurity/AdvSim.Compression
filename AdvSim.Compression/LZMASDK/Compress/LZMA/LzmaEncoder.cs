...
namespace SevenZip.Compression.LZMA
{
	...
	public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties
	{
		...
		const Int32 kDefaultDictionaryLogSize = 22;
		...
		class LiteralEncoder
		{
			public struct Encoder2
			{
				...
				public void Init() { for (Int32 i = 0; i < 0x300; i++) m_Encoders[i].Init(); }
			...
			{ return m_Coders[((pos & m_PosMask) << m_NumPrevBits) + (UInt32)(prevByte >> (8 - m_NumPrevBits))]; }
		}
		...
		Int32 _posStateBits = 2;
		UInt32 _posStateMask = (4 - 1);
		Int32 _numLiteralPosStateBits = 0;
		Int32 _numLiteralContextBits = 3;
		...
		void ReadMatchDistances(out UInt32 lenRes, out UInt32 numDistancePairs)
		{
			...
			if (numDistancePairs > 0)
			{
				...
				if (lenRes == _numFastBytes)
					lenRes += _matchFinder.GetMatchLen((Int32)lenRes - 1, _matchDistances[numDistancePairs - 1],
		...
		Boolean ChangePair(UInt32 smallDist, UInt32 bigDist)
		{
			const Int32 kDif = 7;
		...
		static Int32 FindMatchFinder(String s)
		{
				...
				switch (propIDs[i])
				{
					...
					case CoderPropID.PosStateBits:
					{
						...
						if (v < 0 || v > (UInt32)Base.kNumPosStatesBitsEncodingMax)
							throw new InvalidParamException();
						_posStateBits = (Int32)v;
						_posStateMask = (((UInt32)1) << (Int32)_posStateBits) - 1;
						break;
					}
					case CoderPropID.LitPosBits:
					{
						...
						if (v < 0 || v > (UInt32)Base.kNumLitPosStatesBitsEncodingMax)
							throw new InvalidParamException();
						_numLiteralPosStateBits = (Int32)v;
						break;
					}
					case CoderPropID.LitContextBits:
					{
						...
						if (v < 0 || v > (UInt32)Base.kNumLitContextBitsMax)
							throw new InvalidParamException(); ;
						_numLiteralContextBits = (Int32)v;
						break;
					}
